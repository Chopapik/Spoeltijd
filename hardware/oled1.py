"""
OLED display (first). Fixed I2C address.
Universal API: clear, draw_text, draw_rect, fill. Same interface as Oled2.
"""
...
class Oled1:
    ...
    def __init__(self):
        self._device = ssd1306(i2c(port=PORT_I2C, address=ADDR_OLED_STATUS))
